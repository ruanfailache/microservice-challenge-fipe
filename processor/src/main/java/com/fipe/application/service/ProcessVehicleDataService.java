...
public class ProcessVehicleDataService implements ProcessVehicleDataUseCase {
    ...
    public void processVehicleData(String brandCode, String brandName) {
        try {
            ...
            LOG.errorf(e, "Error processing vehicle data for brand: %s", brandCode);
            throw new VehicleDataProcessingException(
                    "Failed to process vehicle data for brand: " + brandCode, e);
        }
    }
}
